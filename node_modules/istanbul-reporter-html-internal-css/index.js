...
var fs = require('fs'),
    ...
    prettifycss = fs.readFileSync(path.resolve(__dirname, 'assets/vendor/prettify.css'), 'utf8'),
    basecss = fs.readFileSync(path.resolve(__dirname, 'assets/base.css'), 'utf8'),
    prettifyPartial = handlebars.registerPartial('prettify_css', "<style type='text/css'>" + prettifycss + "</style>"),
    basePartial = handlebars.registerPartial('base_css', "<style type='text/css'>" + basecss + "</style>"),
...
function fillTemplate(node, templateData, linkMapper, context) {
    ...
    // templateData.base = {
    //     css: linkMapper.getContent(node, 'base.css')
    // };
    templateData.sorter = {
...
function HtmlReport(opts) {
    ...
    this.linkMapper = opts.linkMapper || inliningLinkMapper;
